...
const galleryCaptions = [
  ...
  "Noon at ngayon.",
  "\"At the end of the day, the goals are simple: Safety and security.\"<br /><span style='font-size: 18px'>- Jodi Rell, former Governor of Connecticut</span>"
];
const galleryDescriptions = [
  ...
  "Pinapakita sa larawang ito ang ilang pagsubok na kinakaharap ng ating mundo. Covid-19 ang pangunahing pinagmulan ng kasalukuyang suliranin na hanggang ngayon ay ginagawan pa rin ng solusyon ng gobyerno at ng iba pang mga indibidwal. Ayon dito sa larawan ay nakasaad ang isa pang halimbawa, ito ay ang tinatawag India Variant na kumalat na rin sa 44 na bansa at patuloy na bumibilis ang pagdami ng nagkakaroon nito. Hanggang sa kasalukuyan ay pinagaaralan na rin ang gamot na makakasugpo sa uri na sakit na ito.<p>Ngunit sa aking pananaw, higit na makakatulong kung ang disiplina ay magsisimula sa bawat isa sa atin. Sa simpleng pag-sunod sa mga pinapalaganap na protokol ay malaking tulong na para sa ating lahat na makabawas sa dagdag-isipin sa mga taong naatasan o mas responsable sa pag-lutas ng mga ganitong suliranin kaya't kahit sa simpleng bagay ay piliin pa rin nating tumulong dahil para rin ito sa ikabubuti ng lahat.</p>"
];
